            ...
            for(int i = 1; i < imageHeight-1; i++){
                for(int j = 1; j < imageWidth-1; j++){
                    ...
                    if(tmpImage[i*imageWidth+j] == 0){
                        ...
                        // if(tmpImage[i*imageWidth+j+1] > 0) X0 = 1;
                        // else X0 = 0;
                        // if(tmpImage[(i-1)*imageWidth+j+1] > 0) X1 = 1;
                        // else X1 = 0;
                        // if(tmpImage[(i-1)*imageWidth+j] > 0) X2 = 1;
                        // else X2 = 0;
                        // if(tmpImage[(i-1)*imageWidth+j-1] > 0) X3 = 1;
                        // else X3 = 0;
                        // if(tmpImage[(i)*imageWidth+j-1] > 0) X4 = 1;
                        // else X4 = 0;
                        // if(tmpImage[(i+1)*imageWidth+j-1] > 0) X5 = 1;
                        // else X5 = 0;
                        // if(tmpImage[(i+1)*imageWidth+j] > 0) X6 = 1;
                        // else X6 = 0;
                        // if(tmpImage[(i+1)*imageWidth+j+1] > 0) X7 = 1;
                        // else X7 = 0;
                        // if(tmpImage[i*imageWidth+j] > 0) X = 1;
                        // else X = 0;
                    ...
                    if(stageOne[i*imageWidth+j] == 0){
                        ...
                        for(int m2_x = i-1; m2_x <= i+1; m2_x++){
                            for(int m2_j = j-1; m2_j <= j+1; m2_j++){
                                if(stageOne[m2_x*imageHeight+m2_j] == 1){
...
private:
    ...
    string thinUncondMark[364] =  { // Spur: 2
                                      ...
                                      "001011100","011010100","011011100",
                                      "110010001","100110001","110110001",
                                      "001010110","001110100","001110110",
                                      "100011001","100010011","100011011",
                                      // Corner Cluster:
                                      "110110000",
                                      "110110001","110111000",
                                      "110111001","111110000","111110001","111111000","111111001","110110010","110110011","110111010",
